...
export default class FsLeadDetailsPropertyBoundaries extends LightningElement {
    @track rowAction = [
        {
            //label: 'Edit',
            type: 'button-icon',
    ...
    getSectionPageContent(recId){
        ...
        getSectionContent({recordIds : recId, metaDetaName : 'Lead_Details_Property_Boundaries'})
        .then(result => {
