...
export default class FsLeadDetailsPropertyMeasurement extends LightningElement {
    @track rowAction = [
        {
            //label: 'Edit',
            type: 'button-icon',
    ...
    getSectionPageContent(recId){
        ...
        getSectionContent({recordIds : recId, metaDetaName : 'Lead_Details_Property_Measurement'})
        .then(result => {
